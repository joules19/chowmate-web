...
interface RiderSendBackToPendingModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function RiderSendBackToPendingModal({
  isOpen,
  onClose,
  onConfirm,
  rider,
  isLoading = false
}: RiderSendBackToPendingModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-4">
            <p className="text-sm text-text-secondary mb-4">
              Send <span className="font-medium text-text-primary">{rider.fullName}</span> back to pending status with instructions.
            </p>
            ...
            <textarea
              ...
              placeholder="Please provide additional documentation or correct the following issues..."
              required
            />
          </div>
